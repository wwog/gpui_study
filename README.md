...
├── 01_basics/              # 第一章：基础概念
│   ├── src/
│   │   ├── main.rs         # Application 和 Window
│   │   ├── render.rs       # Render trait 基础
│   │   └── context.rs      # Context 概念
│   └── Cargo.toml
│
├── 02_elements/            # 第二章：元素系统
│   ├── src/
│   │   ├── main.rs         # Element trait
│   │   ├── div_basic.rs    # div 元素基础
│   │   └── composition.rs  # 元素组合
│   └── Cargo.toml
│
├── 03_state_management/    # 第三章：状态管理
│   ├── src/
│   │   ├── main.rs         # 状态更新机制
│   │   ├── model.rs        # Model 概念
│   │   └── notify.rs       # cx.notify() 响应式更新
│   └── Cargo.toml
│
├── 04_styling/             # 第四章：样式系统
│   ├── src/
│   │   ├── main.rs         # Styled trait
│   │   ├── layout.rs       # Flexbox 布局
│   │   ├── colors.rs       # 颜色系统
│   │   └── responsive.rs   # 响应式设计
│   └── Cargo.toml
│
...
│   └── Cargo.toml
│
├── 06_advanced/            # 第六章：高级主题
│   ├── src/
│   │   ├── main.rs         # 高级特性概述
│   │   ├── actions.rs      # Action 系统
│   │   ├── focus.rs        # 焦点管理
│   │   └── async.rs        # 异步操作
│   └── Cargo.toml
│
